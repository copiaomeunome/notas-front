    ...
    return(
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed inset-0 md:inset-auto overflow-hidden md:-translate-x-1/2 md:-translate-y-1/2 md:left-1/2 md:top-1/2 md:h-max-[60vh] md:max-w-[640px] w-full bg-emerald-500 md:rounded-md flex flex-col outline-none">
